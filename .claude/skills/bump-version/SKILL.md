---
name: bump-version
description: Bump TianWen's version number across ALL four locations that must stay in sync (TianWen.Lib.csproj AssemblyVersion, TianWen.Lib.CLI VersionPrefix, TianWen.UI.FitsViewer VersionPrefix, .github/workflows/dotnet.yml VERSION_PREFIX). Use when the user asks to bump, update, or increment TianWen's version.
---

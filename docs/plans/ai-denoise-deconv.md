...
**Step 0 (archive organization, before any builder code):** `tools/archive-curation/astro-archive-dedup.py`; a
...
| **P3: Ship** (#825) | Auto-order wiring, fetch-script + release assets, CLI/GUI surfacing, `docs` + CLAUDE.md section | `stack --enhance --ai-backend tianwen` end-to-end on a fresh machine (models auto-fetched) |

...
`GET /api/v1/node` shipped (#918), the server built beside its clients (#919), the keeper and the safe stop over the socket (#920); P2 onward not started.** Issue #751. P0 is urgent on its own: it

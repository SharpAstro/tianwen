...
- **A crash journal (DECIDED 2026-09-24, decision 8).** The server keeps a small file beside
  ...
  - **Shipped in P1 part 7b:** acting on it. The cool-down is the session's own, lifted out of `Session` into

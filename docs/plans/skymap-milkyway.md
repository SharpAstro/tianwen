...
### ✅ Phase 1: Shader + Full-Screen Quad (DONE, commit f0b39ac7)
...
### ✅ Phase 2: Texture Pipeline (DONE, commit f0b39ac7)
...
- **Tycho-2 binning first** was the obvious win we were missing; we already
  own the data. The analytical model that shipped in commit f0b39ac7 looks fake

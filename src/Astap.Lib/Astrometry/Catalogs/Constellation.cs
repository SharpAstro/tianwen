...
namespace Astap.Lib.Astrometry.Catalogs
{
    ...
    public static class ConstellationEx
    {
        private static readonly Dictionary<Constellation, (string Genetitive, string BrightestStar)> _info = new()
        {
            ...
            [Constellation.Centaurus] = ("Centauri", "Rigil Kentaurus"),
            [Constellation.Cepheus] = ("Cephei", "Alderamin"),
            [Constellation.Cetus] = ("Ceti", "Diphda"),
            [Constellation.Chamaeleon] = ("Chamaeleontis", "α Chamaeleontis"),
            [Constellation.Circinus] = ("Circini", "α Circini"),
            [Constellation.Columba] = ("Columbae", "Phact"),
            [Constellation.ComaBerenices] = ("Comae Berenices", "β Comae Berenices"),
            [Constellation.CoronaAustralis] = ("Coronae Australis", "Meridiana"),

...
namespace TianWen.UI.Abstractions
{
    ...
    public class PlannerTab<TSurface>(Renderer<TSurface> renderer) : PixelWidgetBase<TSurface>(renderer)
    {
        ...
        // These are PROPERTIES, not static readonly fields: a field initialiser snapshots the palette
        // at type-init, so this tab went on painting the startup scheme through every theme switch.
        // RGBAColor32 is a struct, so reading through allocates nothing.
        ...
        private static RGBAColor32 SelectedText             => GuiTheme.Palette.BodyText;
        // A pin is a positive state, so it borrows Success rather than a teal of its own.
        private static RGBAColor32 PinnedBg                 => GuiTheme.Mix(GuiTheme.Palette.PanelBg, GuiTheme.Palette.Success, 0.25f);
        private static RGBAColor32 PinnedText               => GuiTheme.Palette.Success;
        private static RGBAColor32 RemoveBtnBg              => GuiTheme.Mix(GuiTheme.Palette.PanelBg, GuiTheme.Palette.Error, 0.4f);
        private static RGBAColor32 RemoveBtnText            => GuiTheme.Palette.Error;
        private static RGBAColor32 DimText                  => GuiTheme.Palette.DimText;
        private static RGBAColor32 DetailsBg                => GuiTheme.Palette.ContentBg;
        private static RGBAColor32 DetailsNameText          => GuiTheme.Palette.BodyText;
        private static RGBAColor32 DetailsInfoText          => GuiTheme.Palette.DimText;
        private static RGBAColor32 SeparatorColor           => GuiTheme.Palette.Separator;
        private static RGBAColor32 FilterBtnBg              => GuiTheme.Palette.Separator;
        private static RGBAColor32 ActiveFilterBg           => GuiTheme.Mix(GuiTheme.Palette.PanelBg, GuiTheme.Palette.Success, 0.45f);
        private static RGBAColor32 FilterBtnText            => GuiTheme.Palette.BodyText;
        private static RGBAColor32 DropdownBg               => GuiTheme.Palette.PanelBg;
        private static RGBAColor32 DropdownSelBg            => GuiTheme.Palette.Selection;
        private static RGBAColor32 DropdownBorder           => GuiTheme.Palette.SeparatorStrong;

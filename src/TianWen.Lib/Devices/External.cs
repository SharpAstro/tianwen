...
) : IExternal, IDisposable
{
    ...
    public DirectoryInfo CommonDataRootFolder => TianWenPaths.CommonDataRoot;

    /// <summary>
    /// Gets the directory where application output files are stored. The default location is a subfolder within the
    ...
    public DirectoryInfo OutputFolder => TianWenPaths.CommonDataRoot;

    /// <summary>
    /// Profiles are shared between every consumer of this library, for ease of use
    /// </summary>
    public DirectoryInfo ProfileFolder { get; } = TianWenPaths.CommonDataRoot.CreateSubdirectory("Profiles");

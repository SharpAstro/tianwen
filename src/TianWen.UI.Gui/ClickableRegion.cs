...
/// </summary>
public readonly record struct ClickableRegion(float X, float Y, float Width, float Height, HitResult Result);

/// <summary>
/// Describes what was hit during a click. Carries enough context for
/// Program.cs to handle it without knowing the tab's internal layout.
/// </summary>

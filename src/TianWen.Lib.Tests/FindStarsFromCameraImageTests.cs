...
public class FindStarsFromCameraImageTests
{
    ...
    public async Task GivenCameraImageDataWhenConvertingToImageThenStarsCanBeFound(int snr_min, int expectedStars)
    {
        ...
        // when
        var imageData = Channel.FromWxHImageData(int16WxHData);
        var image = new Image([imageData.Data], BitDepth, imageData.MaxValue, imageData.MinValue, Pedestal, imageMeta);

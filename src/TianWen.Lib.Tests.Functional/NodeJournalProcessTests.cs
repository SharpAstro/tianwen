...
/// reports what was held and what the cooler was asked to do. A node stopped cleanly leaves none. Real processes, on a
/// socket and data root of the test's own, with the fake devices only (<see cref="KeptNode"/>).
/// </summary>

...
- [ ] Use IWeatherDriver ambient temperature for camera warm-up — when no hardware weather station provides heat sink temp, use Open-Meteo's `Temperature` as the ambient target for `CoolCamerasToAmbientAsync` ramp

...
- [ ] Handle refraction — assumes driver does not support/do refraction (`IMountDriver.cs:347`) — still open; the `Refraction = true` assumption (per-driver native-refraction handling) is deliberately out of scope of `PLAN-site-conditions.md`.

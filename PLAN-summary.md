...
| [PLAN-scheduled-starts](PLAN-scheduled-starts.md) | **NOT STARTED** (authored 2026-06-12; `WaitForScheduledStartAsync` at top of `ObservationLoopAsync` so `ScheduledObservation.Start` is honored - chunked SleepAsync wait, lead-time knob, late-start logs, session-end guard) |
